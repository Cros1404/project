        ...
        <div class="container">
        <form action="moveTest7.php" method="post">
        <input type="hidden" name="ID"  value="7" id="ID">
        <h2>Create Test For Lesson: Lesson 4</h2>
  ...
  <div id="myModal" class="modal fade" role="dialog" >
    <div class="modal-dialog" style="width:1000px">
      ...
      <div class="modal-content" style="width:1000px">
        ...
        <form action="buttons.php?id=7" method="post">
        <a href="EditTest7.php"><button type="button"  class="btn btn-warning btn-primary btn-lg">Edit The Test</button></a>
        <?php
        $stmt = $db->prepare("SELECT testPublished FROM lesson where ID = 7");
        $stmt -> execute();
        $x = $stmt -> fetch();
